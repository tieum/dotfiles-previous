...
#set wallpaper
exec_always --no-startup-id feh --bg-fill $HOME/.config/wallpapers/cassette-highres-flip.jpg
...
# is usem in the bar {} block below.
...
bindsym $mod+g exec urxvt -name ranger -title ranger -e ranger
...
# screenshot 
bindsym --release $mod+Shift+s exec --no-startup-id "maim -s -p 0 -c 0.96,0.5,0.09 $HOME/Pictures/Screenshot-$(date +%Y-%m-%d_%H-%M-%S).png" 
...
for_window [title="ranger"] move to workspace $ws5 
...
#Load layout
exec --no-startup-id "i3-msg 'workspace 2:; append_layout ~/.i3/workspace2.json'"
